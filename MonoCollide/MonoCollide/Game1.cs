...
namespace MonoCollide
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            foreach (ModelMesh mesh in scene.Meshes)
            {
                ...
                else
                {
                    ...
                    MeshHelper.AddTriangles(mesh, positions, indices);

                    ITriangleSelector selector = new StaticTriangleSelector(Matrix.Identity, positions, indices, 16);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.DrawString(font, lines[i], new Vector2(0, i * font.MeasureString(lines[i]).Y), Color.Black);
            }
            spriteBatch.End();
